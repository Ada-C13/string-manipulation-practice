...
describe "reverse sentence" do
  describe "basic tests" do
    it "reverse a sentence with two words" do
      ...
      test = reverse_sentence(test_string)

      expect(test).must_equal "world hello,"
    end
    ...
    it "reverse a sentence with three words" do
      ...
      expect(test).must_equal "awesome! is Yoda"
    end
  end
  ...
  describe "edge cases" do
    ...
    it "reverse a sentence with multiple words" do
      ...
      expect(test).must_equal "yesterday. was I than today engineer better a I'm"
    end
    ...
    it "reverse a sentence with multiple spaces between words" do
      ...
      expect(test).must_equal "apples?      them     like   you  do  How"
    end
    ...
    it "reverse a sentence with preceeding and trailing white spaces" do
      ...
      expect(test).must_equal "     this! do can I  "
    end
  end
end
