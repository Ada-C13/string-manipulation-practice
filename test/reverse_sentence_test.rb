...
describe "reverse sentence" do
  describe "basic tests" do
    it "reverse a sentence with two words" do
      ...
      expect(reverse_sentence(test_string)).must_equal "world hello,"
    end

    it "reverse a sentence with three words" do
      test_string = "Yoda is awesome!"

      expect(reverse_sentence(test_string)).must_equal "awesome! is Yoda"
    end
  end
  ...
  describe "edge cases" do
    ...
    it "reverse an empty sentence" do
      ...
      expect(reverse_sentence(test_string)).must_be_empty
    end
